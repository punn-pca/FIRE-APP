...
export const analyzeQuestion = async (analyzeRequest: AnalyzeRequest, options?: RequestInit): Promise<AnalyzeResponse> => {
  ...
  return customFetch<AnalyzeResponse>(getAnalyzeQuestionUrl(),
  {
    ...options,
    method: 'POST',
...
export const getAnalyzeQuestionMutationOptions = <TError = ErrorType<void>,
...
): UseMutationOptions<Awaited<ReturnType<typeof analyzeQuestion>>, TError,{data: BodyType<AnalyzeRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof analyzeQuestion>>, {data: BodyType<AnalyzeRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AnalyzeQuestionMutationBody = BodyType<AnalyzeRequest>
